...
| Job | Today | Evidence |
|---|---|---|
| Price a month's gas before an outside deadline | Five-day window, and Meridian sets none of the dates | Derived |
| Load a file whose format changed without warning | By hand, no notice; 12–15 files rebuilt monthly | Described |
| Chase a source that hasn't sent its data | A spreadsheet, `Tracker$$.xlsx` | Derived |
| Get a bad file replaced instead of repairing it here | Multi-day IT forensics; the answer is usually a new file | Described · **new 2026-08-29** |
| Find the setup that will fail before the run fails | A screen with two exception filters | Derived · **new 2026-08-29** |
| Stop paying on a meter without deleting it, and let others see why | A checkbox, and a column recording who used it | Derived · **new 2026-08-29** |
| Pay a producer once, in a form they can reconcile | Consolidated — but two accounts disagree | Described · **half settled 08-27** |
| Correct an error without reopening a paid month | Never; adjust on the next run | Described · strongest here |
| Keep a correction attached to the month it belongs to | Handled correctly today | Described |
| Notice when a meter under contract is missing from a file | Known and handled by the people who do it | Described · not in scope pages |
| Send a statement package a producer can run their own accounts from | A statement plus a spreadsheet that cannot change | Described |
| Get a statement to the right person, and know it arrived | Two people, two channels | Derived |
| Be able to run the cycle again next month without working it out again | A personal checklist; no formal documentation | Derived |
...
| Job | Today | Evidence |
|---|---|---|
| Approve prices before they become money | A queue with Approve and Cancel, stamped with approver and date | Derived · **new 2026-08-29** |
| Be confident enough to release millions of dollars | About twelve reports; seven check against Des Falk's own spreadsheets | Derived |
| Check the system against something the system didn't produce | His own spreadsheets — a real control, undocumented, one person | Derived |
| Know what was signed off, by whom, and when | Initials and dates across the review workbook | Derived |
...
| Job | Today | Evidence |
|---|---|---|
| Check a deal against everything already signed before issuing anything binding | Formal split — the buyer agrees terms, Contracting verifies | Derived |
| Produce the documents all parties sign | Templates owned by Nora Whitfield, refreshed by an executable | Derived |
| Get a confirmation through the approval gate | Middle Office, "PXT's team"; system of record is email | Derived |
| Know an uploaded deal is the final one | Judgment; nobody has described how | Derived · open question |
| Keep track of a dispute that lives at three other companies | Private spreadsheets; ~44 inquiries, some open over a year | Described |
| Make a change effective on the date it actually takes effect | Possible on one side of the business, not the other | Described · two documented defects |
| Identify the wells behind a meter when it changes hands | Manual back-and-forth; Meridian holds no API numbers | Described · **reframed 2026-08-29** |
| Keep working when a meter number means different things to different parties | Renumber the meter, then sometimes renumber it back | Described · **new 2026-08-29** |
| Work at speed without reaching for the mouse | The current system was built for keyboard-only entry | Described by three people · **scope narrowed 2026-08-29** |
...
| Job | Today | Evidence |
|---|---|---|
| Turn a verbal agreement into a system commitment | Buyer enters a reservation, Contracting converts it | Derived |
| Get a deal papered without chasing it | Not tracked in any system | Derived · open question |
| Avoid paying the wrong party when a meter changes owner | Gus Halloran waits for the payment, then holds the change in his head | Described |
| Work a renewal list to closure, not just see it | ⚠ **A working dashboard already exists** — with notification tracking | Described · **corrected 2026-08-29** |
| Keep working knowledge of producers available to more than four people | It lives in people | Described |
...
| Job | Today | Evidence |
|---|---|---|
| Commit daily volumes to each pipeline in advance | Two tools, with a manual save and re-upload between them | Derived |
| Work out which producers sit inside an affected area | Points of delivery, and bubbles | Derived |
| Tell producers when a pipeline tells us to cut back | By hand; the contact addresses sit in one person's spreadsheet | Derived |
...
| Job | Today | Evidence |
|---|---|---|
| Know when a new producer deal lands | The Horizon Dashboard — which this project retires | Derived |
| Report the physical position without pulling data from outside | Dependent on external data | Derived |
...
| Job | Today | Evidence |
|---|---|---|
| Get the numbers into the general ledger and out to the banks | One button produces a file, uploaded to Silverline Ledger | Derived |
| Prove what we sent matches what the ledger recorded | At least partly manual, line by line | Derived |
| Get a new payee set up before a payment can go out | A coordination process with Accounts Payable | Derived |
| Review and approve transactions independently of the operating team | "PXT's team"; system of record is email | Derived |
| File state taxes on time | Quarterly, inside the payments team; rates held in spreadsheets | Derived |
| Produce the FERC filing | Unknown — a compliance obligation with no identified owner | Derived · open question |
| Know the cost of the gas we bought | A report Finance depends on; grain and audience unsettled | Derived |
| Know what we are going to owe before the month closes | A working forecast screen, owner unknown | Derived · **new 2026-08-29** |
...
| Job | Today | Evidence |
|---|---|---|
| Understand what I was paid and why | One statement per pipeline and gathering system combination | Described · Meridian side only |
| Pay my own royalty owners from what Meridian sends | The spreadsheet attached to the statement | Described · Meridian side only |
| Get a wrong volume put right | Slowly, through parties Meridian cannot compel | Derived |
| Know a payment is coming and what it covers | Sometimes the money arrives before the statement does | Derived · one producer email |
